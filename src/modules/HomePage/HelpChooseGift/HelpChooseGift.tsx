      ...
      <Container>
        <div className="relative z-10 rounded-[16px] xl:rounded-[20px] bg-orange overflow-hidden">
          ...
          <div className="relative z-20 pb-[232px] xs:pb-26 xl:pb-9 px-6 xl:px-14 ">
            ...
            text-[8px] sm:text-[12px] xl:text-[14px] font-normal leading-[120%] shadow-social bg-linear-[121deg,white_22.48%,#FF692D_337.32%] sm:bg-linear-[155.88deg,#ffffff_11.19%,#ff692d_199.95%]"
              >
                Обрати подарунок
              </button>
            </Link>
          ...
          <Image
            ...
            width="592"
            height="550"
            className="xs:hidden absolute z-10 bottom-0 right-0 w-full max-w-[326px] h-auto"
          />
          <Image
