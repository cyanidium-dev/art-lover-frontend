      ...
      <div className="py-8 ">
          <div className="bg-[var(--main-orange-light)] p-[32px]">
              ...
              <form className="flex gap-4" onSubmit={handleSubmit(onSubmit)}>
                  ...
                  <input type="email" placeholder="Email" className="w-full h-[40px]  text-white rounded-2xl px-4  bg-[rgba(255,255,255,0.34)] border-transparent  outline-none placeholder:text-left placeholder:text-[12px] placeholder:font-light placeholder:text-white"
                  {...register("email")}
                  />
