...
const NavbarBurgerMenuContent = ({isOpen, toggleOpen}) => {
  ...
  return (
      ...
      isOpen && createPortal(<AnimatePresence mode="wait">
        <motion.div
          ...
          } z-999 top-0 right-0 left-0 w-[100vw] h-[100vh] bg-[#0000005C] overflow-y-auto flex justify-end`}
        >
          <NavbarNav />
        </motion.div>
      </AnimatePresence>, modalRef.current)
